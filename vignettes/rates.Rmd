...
fmbasics makes it easy to work with interest rates (and discount factors). You can covert from interest rates to discount factors and vice-versa.
...
as_InterestRate(rate, compounding = 1000, day_basis = '30/360us')
```
...
rate2 <- InterestRate(0.01, 1000, 'act/360')
rate1 + rate2
```
