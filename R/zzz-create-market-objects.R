...
#' Standard currencies
#'
#' These functions create currencies with standard market conventions.
#'
...
#' }
#'
#' @return A \code{\link{Currency}} object
#' @examples
#' AUD()
#' USD()
#' @name ccycreators
#' @aliases AUD EUR GBP JPY NZD USD CHF HKD NOK
NULL

#' @rdname ccycreators
#' @export
AUD <- function () Currency$new("AUD",
  c(AUSYCalendar$new()))
#' @rdname ccycreators
#' @export
EUR <- function () Currency$new("EUR",
  c(EUTACalendar$new()))
#' @rdname ccycreators
#' @export
GBP <- function () Currency$new("GBP",
  c(GBLOCalendar$new()))
#' @rdname ccycreators
#' @export
JPY <- function () Currency$new("JPY",
  c(JPTOCalendar$new()))
#' @rdname ccycreators
#' @export
NZD <- function () Currency$new("NZD",
  c(NZAUCalendar$new(), NZWECalendar$new()))
#' @rdname ccycreators
#' @export
USD <- function () Currency$new("USD",
  c(USNYCalendar$new()))
#' @rdname ccycreators
#' @export
CHF <- function () Currency$new("CHF", c(CHZHCalendar$new()))
#' @rdname ccycreators
#' @export
HKD <- function () Currency$new("HKD", c(HKHKCalendar$new()))
#' @rdname ccycreators
#' @export
NOK <- function () Currency$new("NOK", c(NOOSCalendar$new()))
